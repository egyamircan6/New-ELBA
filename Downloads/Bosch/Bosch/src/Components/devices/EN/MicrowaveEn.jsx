...
import MicrowavefaqEn from '../../faq/EN/MicrowavefaqEn';

export default function MicrowaveEn() {
  return (
    <div dir="ltr" className="bg-white space-y-24">
      ...
      <Helmet>
        <title>
        Authorized Bosch Microwave Repair Egypt | Bosch Agency 01211114528
        </title>

        <meta
          name="description"
          content="Book Bosch microwave repair from Bosch Egypt with immediate home service, original spare parts, and an official warranty. Fast coverage across all governorates. Call 01211114528 to book a specialist."
        />
      ...
      >
        ...
        Welcome to Authorized Bosch Microwave Repair
          </h1>

          <p className="text-gray-200 mb-8">
            Authorized Bosch Microwave Repair by Bosch Egypt
          </p>
  ...
  <h2 className="text-2xl text-center font-semibold mb-16">
    Why Choose Our Bosch Microwave Maintenance Center?
  </h2>
  ...
  <div className="max-w-6xl mx-auto space-y-20">
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      <div>
        ...
        <p className="text-gray-600 leading-loose">
          Maintaining a microwave requires deep expertise in radiation safety
          and electronic timing. Our team is trained to handle Bosch microwave
          faults such as weak heating, plate rotation failure, control panel
          glitches, and door sensor issues.
        </p>
      </div>
      ...
      <div className="flex justify-center">
        <img
          ...
          alt="Bosch microwave maintenance"
        />
      </div>
    </div>
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      <div className="md:order-2 flex justify-center">
        <img
          src={img}
          className="w-full max-w-md rounded-xl shadow-2xl"
          alt="Bosch microwave original spare parts"
        />
      </div>
      ...
      <div className="md:order-1">
        ...
        <p className="text-gray-600 leading-loose">
          We use 100% original Bosch spare parts including Magnetron units,
          high-voltage transformers, door sensors, and glass trays. Genuine
          components ensure stable performance and extend the life of your
          microwave.
        </p>
      </div>
    </div>
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      <div>
        ...
        <p className="text-gray-600 leading-loose">
          Our engineers repair complex issues including sparking inside the
          cavity, dead power units, and unresponsive touch panels. We diagnose
          the root cause to prevent repeated faults in built-in and countertop
          Bosch microwaves.
        </p>
      </div>
