...
import FlatsfaqEN from '../../faq/EN/FlatsfaqEN';
import { Helmet } from 'react-helmet-async';

export default function FlatsEN() {
  return (
    <div dir="ltr" className="bg-white space-y-24">
      ...
      <Helmet>
        <title>
          Authorized Bosch Hob Repair in Egypt | Bosch Egypt Agency 01211114528
        </title>

        <meta
          name="description"
          content="Book Bosch hob maintenance from Bosch Egypt with fast home service, original spare parts, and an official warranty. Repair for Bosch built-in and electric hobs."
        />
      ...
      >
        ...
        <div className="relative z-10 text-white max-w-3xl px-4">
          <h1 className="text-3xl md:text-5xl font-bold mb-6">
            Bosch Hob Repair Center | Request Service Now
          </h1>

          <p className="text-gray-200 mb-8">
            Authorized Bosch Hob Repair by Bosch Egypt
          </p>
  ...
  <div className="max-w-6xl mx-auto space-y-20">
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      <div>
        <h3 className="text-2xl font-semibold mb-4">
          Precision in Deep Freezer Maintenance
        </h3>

        <p className="text-gray-600 leading-loose">
          Bosch deep freezer repair requires accurate diagnosis of the cooling
          cycle, thermostat, compressor, fan motor, and defrost system. Our team
          checks every technical point carefully to restore stable freezing
          performance and prevent repeated faults.
        </p>
      </div>
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      ...
      <div className="md:order-1">
        ...
        <p className="text-gray-600 leading-loose">
          We use original Bosch spare parts such as compressors, sensors,
          thermostats, fans, door seals, and control boards. Genuine components
          protect the cooling system and help your freezer maintain strong,
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      <div>
        ...
        <p className="text-gray-600 leading-loose">
          Our engineers handle weak freezing, ice buildup, compressor failure,
          unusual noise, power issues, and temperature instability. We identify
          the root cause of the fault and complete the repair safely at your
          home.
        </p>
      </div>
