...
const blogArticles = [
  {
    ...
    excerptAr:
      "تعلم كيفية الحفاظ على بوتاجاز إلبا في حالة ممتازة مع هذه النصائح البسيطة للصيانة.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    excerptAr:
      "علامات تشير إلى أن الوقت قد حان لتغيير فلتر الشفاط للحصول على أداء مثالي.",
  },
];
...
const Home = () => {
  ...
  const services = [
    {
      ...
      desc: t("services.repair.desc"),
    },
    {
      icon: Settings,
      title: t("services.installation.title"),
      desc: t("services.installation.desc"),
    },
    {
      icon: Shield,
  ...
  const features = [
    {
      icon: BadgeCheck,
      labelEn: "Certified Technicians",
      labelAr: "فنيون معتمدون",
    },
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content="احصل على أفضل خدمة صيانة elba في مصر مع مركز متخصص في تصليح أجهزة البا بالمنزل. نوفر قطع غيار أصلية وضمان صيانة مكتوب مع استجابة سريعة داخل القاهرة. اتصل الآن لحجز فني صيانة elba بأعلى معايير الجودة."
        />
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center text-white leading-[3] ">
            <h1 className="text-4xl md:text-5xl lg:text-4xl font-bold mb-6 animate-fade-in-up font-cairo lg:leading-[4rem]">
              مركز صيانة elba في مصر – صيانة البا بالمنزل وقطع غيار أصلية بضمان
              معتمد
            </h1>
            <p
        ...
        <div className="container mx-auto px-4">
          ...
          >
              ...
              <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-primary/20 to-accent/20 p-8">
                ...
                <div className="bg-gradient-to-br from-[#e0f2fe] to-[#bae6fd] rounded-xl p-6">
                  <div className="text-center mb-4">
                    <span
                      className={cn(
                        "inline-block bg-primary text-primary-foreground px-4 py-2 rounded-lg font-bold",
                      )}
                    >
            ...
            >
              <h2
                className={cn(
                  "text-2xl md:text-3xl font-bold mb-6 text-foreground",
                )}
              >
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                <ul>
                  ...
                  <li>
                    <strong>نقدم خدمة صيانة البا في مصر</strong> وفق أعلى معايير
                    الجودة
                  </li>
                  ...
                  <li>
                    يمكننا <strong>صيانة البا بالمنزل</strong> دون الحاجة لنقل
                    الجهاز
                  </li>

                  <li>
                    استجابة سريعة عبر <strong>رقم صيانة البا</strong> وخدمة
                    العملاء 24/7
                  </li>

                  <li>لدينا تغطية واسعة داخل القاهرة والجيزة والإسكندرية.</li>

                  <li>
                    لدينا شفافية كاملة في تكلفة{" "}
                    <strong>تصليح أجهزة elba</strong> قبل بدء العمل مع خصومات
                    على أول صيانة.
                  </li>

                  <li>
                    خبرة طويلة في <strong>مركز صيانة elba</strong> لجميع
                    الموديلات الحديثة والقديمة
                  </li>
                </ul>
              </p>
              <p className="text-muted-foreground leading-relaxed mb-8">
                كمان بنحرص على تقديم خدمة عملاء سريعة ومتجاوبة مع كل استفساراتك،
                مع متابعة مستمرة بعد الصيانة للتأكد إن جهازك بيشتغل بكفاءة تامة
                وبدون أي مشاكل."
              </p>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                <ul>
                  <li>
                    <p>
                      نقدم <strong>صيانة elba بالمنزل</strong> لجميع الأجهزة،
                      بما في ذلك{" "}
                      <a
                      ...
                      . فريق <strong>فني صيانة البا</strong> لدينا مؤهل للتعامل
                      مع الأعطال الكهربائية والميكانيكية ولوحات التحكم
                      الإلكترونية بدقة عالية. يتم فحص الجهاز بالكامل قبل وبعد
                      الإصلاح لضمان استقرار الأداء. إذا كنت تبحث عن{" "}
                      <a
                      ...
                      <strong>01211114528</strong> لحجز زيارة منزلية في أقرب
                      موعد.
                    </p>
                  </li>
                </ul>
                ...
                <ul>
                  <li>
                    <p>
                      ...
                      <strong>
                        قطع غيار البا الأصلية والمتوافقة مع المعايير الفنية
                      </strong>{" "}
                      لضمان أفضل أداء بعد الصيانة. جميع المكونات يتم اختبارها
                      قبل التركيب، ويتم التأكد من كفاءة الجهاز بالكامل بعد
                      الإصلاح. نقدم <strong>ضمان صيانة elba مكتوب</strong> يمنحك
                      راحة وثقة بعد انتهاء الخدمة. استخدام قطع غيار مطابقة
                      للمواصفات يحافظ على العمر الافتراضي للجهاز ويمنع تكرار
                      الأعطال. للاستفسار عن توفر القطع أو تكلفة الإصلاح، اتصل
                      مباشرة على{" "}
                      <a
                        href="https://alba-eg.com/%D8%B1%D9%82%D9%85-%D8%B5%D9%8A%D8%A7%D9%86%D8%A9-%D8%A7%D9%84%D8%A8%D8%A7"
                        style={linkBlueStyle}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              ...
              <Link
                key={branch.slug}
                to={localePath(`/branches/${branch.slug}`)}
              >
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-[#0ea5e9] via-[#38bdf8] to-[#7dd3fc] overflow-hidden">
        <div className="container mx-auto px-4">
          ...
          >
            <div className="text-white animate-fade-in-up order-2 lg:order-1">
              ...
              <p className="text-white/90 leading-relaxed mb-6">
                <ul>
                  <li>
                    <p>
                      حجز <strong>صيانة البا بالمنزل</strong> يتم بسهولة عبر
                      التواصل مع فريق خدمة العملاء على الرقم{" "}
                      <a
                        href="https://alba-eg.com/%D8%B1%D9%82%D9%85-%D8%B5%D9%8A%D8%A7%D9%86%D8%A9-%D8%A7%D9%84%D8%A8%D8%A7"
                        style={linkBlueStyle}
                      >
                      ...
                      . بعد تسجيل بيانات الجهاز ونوع العطل، يتم تحديد موعد زيارة
                      مناسب، ثم يقوم فني صيانة ELBA بفحص الجهاز وتشخيص المشكلة
                      بدقة. يتم إبلاغ العميل بتفاصيل الإصلاح والتكلفة قبل
                      التنفيذ لضمان الشفافية الكاملة. هدفنا توفير تجربة صيانة
                      احترافية وسريعة دون الحاجة إلى نقل الجهاز أو تحمل عناء
                      الانتظار الطويل.
                    </p>
                  </li>
                </ul>
            ...
            <div
              className="relative animate-fade-in-up order-1 lg:order-2"
              style={{ animationDelay: "0.2s" }}
            >
            ...
            <div className="text-white animate-fade-in-up order-2 lg:order-1">
              ...
              <p className="text-white/90 leading-relaxed mb-6">
                <ul>
                  <li>
                    <p>
                      نتعامل مع أشهر أعطال <strong>أجهزة elba</strong> مثل ضعف
                      شعلة البوتاجاز، عطل الإشعال الذاتي، توقف الفرن عن التسخين،
                      تسريب الغاز، وضعف أداء الشفاط. كما نقوم بإصلاح الأعطال
                      الكهربائية ولوحات التحكم بدقة عالية باستخدام معدات فحص
                      متخصصة. يعتمد نجاح{" "}
                      <a
                        href="https://alba-eg.com/%D8%B5%D9%8A%D8%A7%D9%86%D8%A9-%D8%A7%D9%84%D8%A8%D8%A7-%D9%81%D9%8A-%D9%85%D8%B5%D8%B1"
                        style={linkBlueStyle}
                      ...
                      على التشخيص الصحيح من البداية، وهو ما نحرص عليه في كل
                      زيارة. إذا لاحظت أي مشكلة في جهازك، تواصل فورًا على{" "}
                ...
                <ul>
                  <li>
                    <p>
                      ...
                      يمكنك الحصول على <strong>صيانة البا في القاهرة</strong>{" "}
                      بسرعة استجابة وزيارات منزلية مجهزة بالكامل من مراكزنا
                      الموزعة في جميع أنحاء القاهرة. كما نقدم صيانة داخل الجيزة
                      ويمكنك ملء الفورم{" "}
                      <a
                        href="https://alba-eg.com/%D8%B1%D9%82%D9%85-%D8%B5%D9%8A%D8%A7%D9%86%D8%A9-%D8%A7%D9%84%D8%A8%D8%A7"
                        style={linkBlueStyle}
                      ...
                      .
                      <br />
                      فـ سواء كنت تبحث عن <strong>
                        مركز صيانة ELBA موثوق
                      </strong>{" "}
                      أو فني متخصص لإصلاح الأعطال في المنزل، نضمن لك خدمة
                      احترافية بمعايير جودة عالية. فريقنا مستعد للوصول إليك في
                      أقرب وقت لتقديم خدمة مطابقة للمواصفات الفنية المعتمدة.
                    </p>
                  </li>
                </ul>
              </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="text-center p-6 bg-card rounded-2xl shadow-md hover-lift"
              >
