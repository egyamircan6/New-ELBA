...
const SheikhZayedPageAr = () => {
  const [isServicePopupOpen, setIsServicePopupOpen] = useState(false);

  const metaTitle = `صيانة البا الشيخ زايد | تصليح أجهزة Elba منزلية فورية`;
  const metaDescription = `خدمة صيانة البا في الشيخ زايد بقطع غيار أصلية. فنيين خبراء في تصليح بوتاجازات وأفران وشفاطات Elba بالمنزل. ضمان معتمد واتصال فوري على 01211114528.`;

  const faqs: FaqItemType[] = useMemo(
    () => [
      {
        q: "ما هو رقم صيانة البا الشيخ زايد لطلب فني فوراً؟",
        a: (
          <p>
            يمكنك الاتصال بنا مباشرة عبر الرقم{" "}
            <a
            ...
            ؛ نحن نوفر أسرع خدمة تصليح منزلي لأجهزة Elba في زايد والخمائل.
          </p>
        ),
      ...
      {
        q: "هل يوجد فني صيانة بوتاجاز البا قريب مني في بيفرلي هيلز؟",
        a: (
          <p>
            نعم، لدينا فنيون متاحون لتقديم خدمة{" "}
            <a
            ...
            للقيام بالإصلاح الفوري بقطع غيار أصلية.
          </p>
        ),
  ...
  const schemaGraph = useMemo(() => {
    return {
      ...
      "@graph": [
        {
          "@type": "LocalBusiness",
          name: "صيانة البا الشيخ زايد",
          url: "https://alba-eg.com/صيانة-البا-الشيخ-زايد",
          image:
          ...
          areaServed: { "@type": "City", name: "الشيخ زايد" },
        },
        {
          "@type": "FAQPage",
          mainEntity: [
            {
              "@type": "Question",
              name: "كيف أحجز موعد صيانة البا في الشيخ زايد؟",
              acceptedAnswer: {
                "@type": "Answer",
                text: "يمكنك التواصل معنا مباشرة عبر رقم صيانة البا 01211114528، وسيصلك الفني في غضون 24 ساعة.",
              },
            },
          ],
        },
          ...
          <div className="container mx-auto px-4 h-full flex items-center justify-center">
            <div className="text-center text-white z-10 max-w-3xl">
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 font-cairo leading-tight lg:leading-[5rem]">
                صيانة البا في الشيخ زايد | خدمة منزلية معتمدة{" "}
              </h1>
              ...
              <div className="lg:col-span-7 lg:order-1">
                <div className="max-w-none space-y-4 text-right">
                  <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-2 font-cairo lg:mt-16">
                    أسرع مركز صيانة أجهزة البا في مدينة الشيخ زايد{" "}
                  </h2>

                  <div className="space-y-3 ">
                    <p className="text-muted-foreground leading-relaxed lg:leading-10 font-cairo lg:text-2xl font-semibold">
                      إذا كنت من سكان مدينة السادس من أكتوبر أو تبحث عن نجدة
                      فنية داخل كمبوندات زايد، فإننا نوفر لك الحل الأمثل عبر
                      خدمة
                      <a
                        className={LINK_CLASS}
                      ...
                      المخصصة لغرب القاهرة. نحن ندرك أن رفاهية مطبخك تعتمد على
                      كفاءة أجهزتك، لذا خصصنا فريقاً من المهندسين المحترفين
                      للتحرك الفوري بمجرد تواصلكم على **{" "}
                      <a
                        className={LINK_CLASS}
      ...
      <section className="py-12 md:py-16 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-8 font-cairo text-right">
            الأسئلة الشائعة - صيانة البا الشيخ زايد
          </h2>
...
export default SheikhZayedPageAr;
