...
const DokkiPageAr = () => {
  ...
  const metaTitle = `صيانة البا في الدقي | رقم توكيل Elba المعتمد وتصليح فورى`;
  const metaDescription = `توكيل صيانة البا في الدقي المعتمد. مركز تصليح أجهزة Elba في مصدق ومحيي الدين أبو العز بقطع غيار أصلية وضمان 12 شهر. اتصل الآن على 01211114528.`;

  const faqs: FaqItemType[] = useMemo(
    () => [
      {
        q: "ما هو رقم صيانة البا الدقي لطلب فني تصليح فوراً؟",
        a: (
          <p>
            <span>رقم صيانة البا الدقي المعتمد هو </span>
            <a
            ...
            <span>
              ؛ اتصل بنا الآن ليصلك مهندس متخصص في فحص وإصلاح أجهزة Elba بمنزلك
              خلال ساعات قليلة.
            </span>
          </p>
        ),
      ...
      {
        q: "هل يتوفر فني صيانة بوتاجاز البا في شارع مصدق أو محيي الدين؟",
        a: (
          <p>
            ...
            <span>
              {" "}
              يغطي منطقة الدقي بالكامل فور طلبك للخدمة على مدار الساعة.
            </span>
          </p>
        ),
      ...
      {
        q: "كيف أحجز موعد تصليح أفران البا في منطقة الدقي؟",
        a: (
          <p>
            ...
            <span>
              {" "}
              للقيام بالإصلاح الفوري بقطع غيار أصلية وضمان معتمد داخل منزلك.
            </span>
          </p>
        ),
      ...
      {
        q: "هل يوفر توكيل الدقي قطع غيار شفاط البا الأصلية؟",
        a: (
          <p>
            ...
            <span>
              {" "}
              تتم باستخدام قطع غيار إيطالية لضمان أعلى كفاءة لشفط الدهون
              والتهوية في مطبخك.
            </span>
          </p>
        ),
      ...
      {
        q: "هل توجد خدمة صيانة غسالات أطباق البا في الدقي",
        a: (
          <p>
            <span>نعم، نحن متخصصون في </span>
            <a
            ...
            <span> بقطع غيار أصلية وضمان حقيقي لضمان راحة عملائنا بالدقي</span>
          </p>
        ),
        aText: `اتصل برقم خدمة عملاء بوتاجاز البا ${PHONE_DISPLAY} فور ملاحظة أي خلل مثل تسريب الغاز أو ضعف الحرارة أو توقف الفرن، لتسجيل البلاغ وتحديد موعد صيانة منزلية مع متابعة الطلب حتى الانتهاء.`,
      },
  ...
  const schemaGraph = useMemo(() => {
    return {
      ...
      "@graph": [
        {
          "@type": "LocalBusiness",
          name: "مركز صيانة البا الدقي المعتمد",
          url: "https://alba-eg.com/صيانة-البا-في-الدقي",
          image:
          ...
          areaServed: [
            { "@type": "City", name: "الدقي" },
            { "@type": "City", name: "شارع مصدق" },
            { "@type": "City", name: "محيي الدين أبو العز" },
            { "@type": "City", name: "ميدان فيني" },
          ],
        },
        {
          "@type": "FAQPage",
          mainEntity: [
            {
              "@type": "Question",
              name: "ما هو رقم صيانة البا الدقي لطلب فني تصليح فوراً؟",
              acceptedAnswer: {
                "@type": "Answer",
                text: "رقم صيانة البا الدقي المعتمد هو 01211114528. نصلك في الدقي ومحيي الدين ومصدق بقطع غيار أصلية وضمان.",
              },
            },
            {
              "@type": "Question",
              name: "هل يوجد فني صيانة بوتاجاز البا قريب مني في شارع مصدق؟",
              acceptedAnswer: {
                "@type": "Answer",
                text: "نعم، نوفر خدمة صيانة بوتاجاز البا وصيانة بوتاجاز البا بلت ان في شارع مصدق وكافة أحياء الدقي فور طلبك للخدمة.",
              },
            },
            {
              "@type": "Question",
              name: "كيف أحجز موعد تصليح أفران البا في منطقة الدقي؟",
              acceptedAnswer: {
                "@type": "Answer",
                text: "الحجز يتم عبر الاتصال بالرقم 01211114528؛ حيث نرسل خبيراً في صيانة افران البا وصيانة فرن البا بلت ان للإصلاح الفوري بالمنزل.",
              },
            },
            {
              "@type": "Question",
              name: "هل يوفر توكيل الدقي قطع غيار شفاط البا الأصلية؟",
              acceptedAnswer: {
                "@type": "Answer",
                text: "بالتأكيد، كافة أعمال صيانة شفاط البا وصيانة شفاط البا بلت ان تتم باستخدام قطع غيار إيطالية أصلية وبضمان معتمد.",
              },
            },
            {
              "@type": "Question",
              name: "هل توجد خدمة صيانة غسالات أطباق البا في الدقي؟",
              acceptedAnswer: {
                "@type": "Answer",
                text: "نعم، نحن متخصصون في صيانة غسالات اطباق البا وصيانة غسالات اطباق البا بلت ان بقطع غيار أصلية وضمان حقيقي داخل الدقي.",
              },
            },
          ],
        },
          ...
          <div className="container mx-auto px-4 h-full flex items-center justify-center">
            <div className="text-center text-white z-10 max-w-3xl">
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 font-cairo leading-tight lg:leading-[5rem]">
                صيانة البا في الدقي | رقم توكيل Elba المعتمد
              </h1>
          ...
          <div className="space-y-12">
                ...
                <div className="max-w-none space-y-4 text-right">
                  ...
                  <div className="space-y-3 ">
                    <p className="text-muted-foreground leading-relaxed lg:leading-10 font-cairo lg:text-2xl font-semibold">
                      ...
                      <span>
                        {" "}
                        لتلبية احتياجات سكان حي الدقي الراقي. نحن ندرك أهمية
                        الوقت لعملائنا في هذه المنطقة الحيوية، لذا وفرنا طاقماً
                      ...
                      <span>
                        {" "}
                        المعتمد، لنصلك في شوارع مصدق، محيي الدين أبو العز،
                        وميدان فيني، وحتى الدقي القديم. نضمن لك خدمة تتسم
                        بالسرعة والنظافة التامة أثناء العمل، مع فحص الجهاز بأحدث
                        الوسائل التكنولوجية لضمان عودته للعمل بكفاءة إيطالية
                        كاملة من الزيارة الأولى، مما يوفر عليك عناء نقل الأجهزة
                        الثقيلة ويضمن لك استمرارية عمل مطبخك بأمان تام.
                      </span>
                    </p>
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
              <div className=" lg:col-span-7 lg:order-2">
                <div className="max-w-none space-y-4 text-right">
                  <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-2 font-cairo lg:mt-16">
                    توكيل تصليح Elba الدقي بقطع غيار أصلية وضمان{" "}
                  </h2>
                  ...
                  <div className="space-y-3 ">
                    <p className="text-muted-foreground leading-relaxed lg:leading-10 font-cairo lg:text-2xl font-semibold">
                      ...
                      <span>
                        {" "}
                        في الدقي بمواصفات الجودة العالمية. نحن نتميز عن غيرنا
                        بالاعتماد الحصري على قطع غيار إيطالية أصلية بضمان
                        التوكيل، مما يساهم في إطالة العمر الافتراضي للجهاز
                        وحمايته من الأعطال المفاجئة. يقوم خبراء الصيانة لدينا
                        بتقديم دعم فني مخصص يشمل الفحص الوقائي الشامل لجميع
                        بوتاجازات وأفران وشفاطات Elba، مع تسليم العميل شهادة
                        ضمان معتمدة وموثقة تضمن له حق الصيانة المجانية. هدفنا هو
                        تقديم تجربة صيانة مريحة وشفافة لسكان الدقي، تجمع بين
                        المهارة الهندسية الفائقة والالتزام الصارم بالمواعيد
                        لتلبية كافة تطلعاتكم في الحفاظ على أجهزتكم المنزلية
                        الفاخرة.
                      </span>
                    </p>
                  </div>
      ...
      <section className="py-12 md:py-16 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-8 font-cairo text-right">
            الأسئلة الشائعة - صيانة البا الدقي (إجابات سريعة)
          </h2>
