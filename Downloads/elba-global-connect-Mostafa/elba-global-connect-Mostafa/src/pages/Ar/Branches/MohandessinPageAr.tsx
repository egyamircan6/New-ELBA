...
const MohandessinPageAr = () => {
  const [isServicePopupOpen, setIsServicePopupOpen] = useState(false);

  const metaTitle = `صيانة البا المهندسين | رقم توكيل Elba المعتمد في الجيزة`;
  const metaDescription = `توكيل صيانة البا المهندسين المعتمد. مركز تصليح أجهزة Elba في شارع جامعة الدول العربية والبطل أحمد عبد العزيز بقطع غيار أصلية وضمان. اتصل الآن على 01211114528.`;

  const faqs: FaqItemType[] = useMemo(
    () => [
      {
        q: "ما هو رقم صيانة البا المهندسين المعتمد للطلبات المستعجلة؟",
        a: (
          <p>
            <strong>رقم صيانة البا المهندسين</strong>
            <span> هو </span>
            <a
            ...
            <span>
              ؛ تواصل معنا الآن لطلب فني متخصص يصلك في شارع جامعة الدول أو البطل
              خلال ساعات.
            </span>
          </p>
        ),
      ...
      {
        q: "هل يوجد فني صيانة بوتاجاز البا قريب مني في المهندسين؟",
        a: (
          <p>
            <span>نعم، لدينا فنيون متاحون لخدمة </span>
            <a
            ...
            <span> في كافة أحياء المهندسين وميت عقبة فور اتصالك بالرقم </span>
            <a
              href="https://api.whatsapp.com/send/?phone=201211114528&text&type=phone_number&app_absent=0"
              className={LINK_CLASS}
              target="_blank"
      ...
      {
        q: "كيف أحجز موعد صيانة أفران البا بالمنزل في المهندسين؟",
        a: (
          <p>
            <span>الحجز يتم بمكالمة واحدة؛ نرسل لك مهندساً خبيراً في </span>
            <a
            ...
            <span> للقيام بالإصلاح الفوري بقطع غيار إيطالية مختومة.</span>
          </p>
        ),
      ...
      {
        q: "هل يوفر توكيل المهندسين صيانة شفاط البا؟",
        a: (
          <p>
            ...
            <span>
              {" "}
              لضمان أفضل تهوية لمطبخك، مع تقديم ضمان على قطع الغيار المستبدلة.
            </span>
          </p>
        ),
        aText: `اتصل برقم خدمة عملاء بوتاجاز البا ${PHONE_DISPLAY} فور ملاحظة أي خلل مثل تسريب الغاز أو ضعف الحرارة أو توقف الفرن، لتسجيل البلاغ وتحديد موعد صيانة منزلية مع متابعة الطلب حتى الانتهاء.`,
      ...
      {
        q: "ما هو رقم توكيل صيانة غسالات أطباق البا في المهندسين؟",
        a: (
          <p>
            ...
            <span> المعتمدة في المهندسين والدقي.</span>
          </p>
        ),
        aText: `اتصل برقم خدمة عملاء بوتاجاز البا ${PHONE_DISPLAY} فور ملاحظة أي خلل مثل تسريب الغاز أو ضعف الحرارة أو توقف الفرن، لتسجيل البلاغ وتحديد موعد صيانة منزلية مع متابعة الطلب حتى الانتهاء.`,
      },
  ...
  const schemaGraph = useMemo(() => {
    return {
      ...
      "@graph": [
        {
          "@type": "LocalBusiness",
          name: "صيانة البا المهندسين",
          url: "https://alba-eg.com/صيانة-البا-المهندسين",
          image:
        ...
        },
        {
          ...
          mainEntity: [
            {
              "@type": "Question",
              name: "ما هو رقم صيانة البا المهندسين المعتمد؟",
              acceptedAnswer: {
                "@type": "Answer",
                text: "رقم صيانة البا المهندسين المعتمد هو 01211114528، متاح لاستقبال بلاغات الأعطال وطلب تصليح منزلي فوري بجميع مناطق المهندسين والجيزة.",
              },
            },
          ],
        },
          ...
          <div className="container mx-auto px-4 h-full flex items-center justify-center">
            <div className="text-center text-white z-10 max-w-3xl">
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 font-cairo leading-tight lg:leading-[5rem]">
                صيانة البا في المهندسين | رقم توكيل Elba المعتمد
              </h1>
          ...
          <div className="space-y-12">
                ...
                <div className="max-w-none space-y-4 text-right">
                  ...
                  <div className="space-y-3 ">
                    <p className="text-muted-foreground leading-relaxed lg:leading-10 font-cairo lg:text-2xl font-semibold">
                      ...
                      <span>
                        {" "}
                        خصيصاً لسكان حي المهندسين الراقي. نحن ندرك أن تعطل أجهزة
                        المطبخ يربك يومك، لذا وفرنا فريقاً من أمهر الفنيين
                        الجاهزين للتحرك الفوري بمجرد تواصلكم على{" "}
                      </span>
                      <a
                      ...
                      <span>
                        {" "}
                        المعتمد، نصلك في شوارع جامعة الدول العربية، ومحيط نادي
                        الصيد، والبطل أحمد عبد العزيز، وصولاً إلى منطقة ميت
                        عقبة. نلتزم بتقديم فحص فني شامل ومعالجة فورية لكافة
                        الأعطال بالمنزل، مع الحفاظ على أعلى معايير النظافة
                        والاحترافية التي تليق بعملاء Elba في قلب الجيزة، مما
                        يضمن لك عودة أجهزتك للعمل بكفاءتها الإيطالية المعهودة في
                        أسرع وقت.
                      </span>
                    </p>
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
              <div className=" lg:col-span-7 lg:order-2">
                <div className="max-w-none space-y-4 text-right">
                  <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-2 font-cairo lg:mt-16">
                    توكيل تصليح Elba المهندسين بقطع غيار اصلية وضمان
                  </h2>

                  <div className="space-y-3 ">
                    <p className="text-muted-foreground leading-relaxed lg:leading-10 font-cairo lg:text-2xl font-semibold">
                      <span>يعتبر مركزنا هو الخيار الموثق لإتمام عمليات </span>
                      <a
                      ...
                      <span>
                        {" "}
                        في المهندسين باستخدام قطع غيار أصلية ومعتمدة تضمن
                        استدامة الأداء. نحن نتميز بامتلاك خبرة تمتد لسنوات في
                        التعامل مع موديلات البلت ان الحديثة، وتعتمد على أجهزة
                        كشف أعطال متطورة توفر عليك الوقت وتحدد المشكلة بدقة
                        متناهية من الزيارة الأولى. يحرص مهندسونا على تقديم شهادة
                        ضمان معتمدة على كافة أعمال التصليح المنزلي، مما يمنح
                        سكان حي المهندسين والدقي الأمان الكامل والراحة في
                        التعامل مع توكيل يضع الجودة والشفافية على رأس أولوياته،
                        مع ضمان توفير الصيانة الدورية التي تحمي أجهزتكم من
                        الأعطال المفاجئة وتطيل عمرها الافتراضي بشكل ملحوظ.
                      </span>
                    </p>
                  </div>
      ...
      <section className="py-12 md:py-16 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-8 font-cairo text-right">
            الأسئلة الشائعة - صيانة البا المهندسين
          </h2>
...
export default MohandessinPageAr;
