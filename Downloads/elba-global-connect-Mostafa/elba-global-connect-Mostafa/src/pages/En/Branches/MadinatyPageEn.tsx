...
const MadinatyPageEn = () => {
  const [isServicePopupOpen, setIsServicePopupOpen] = useState(false);

  const metaTitle = `Elba Maintenance in Madinaty | American Group Service 01211114528`;
  const metaDescription = `Premier Elba Maintenance in Madinaty for hobs and ovens. Authorized American Group repair with original Italian parts. Call 01211114528 today.`;
  const sections: SectionItem[] = useMemo(
    () => [
      {
        title: "Authorized Elba Maintenance in Madinaty by American Group",
        body: (
          <>
            <p>
              <span>
                Madinaty residents can now experience the highest level of{" "}
              </span>
              <strong>Elba Maintenance in Madinaty</strong>
              <span> through the specialized services of </span>
              <a
              ...
              <span>
                . We understand that life in a modern city like Madinaty
                requires fast and efficient technical support, especially for
                luxury{" "}
              </span>
              <a
              ...
              <span> appliances. By calling our </span>
              <a
              ...
              <span>
                , you gain access to a dedicated team that serves all Madinaty
                villas and apartments. Our experts for{" "}
              </span>
              <strong>Elba Maintenance in Madinaty</strong>
              <span>
                {" "}
                are equipped with original Italian components to ensure your
                built-in appliances are back to peak performance on the same
                day.
              </span>
            </p>
          </>
        ...
        image: {
          src: cooker1,
          alt: "Authorized Elba Maintenance in Madinaty by American Group",
          label: "Elba Maintenance in Madinaty",
        },
      },
      {
        title: "Professional Elba Maintenance in Madinaty for Cookers & Ovens",
        body: (
          <>
            <span>Choosing </span>
            <strong>Elba Maintenance in Madinaty</strong>
            <span>
              {" "}
              means opting for safety and long-term reliability for your
              kitchen. Our expertise in{" "}
            </span>
            <a
            ...
            <span>
              ...
              your doorstep in any Madinaty district. As a leading{" "}
            </span>
            ...
            <span>
              {" "}
              service visit is equipped with authentic Italian components. We
              take pride in our technical mastery, helping Madinaty families
              maintain the elegance of their high-end built-in cooking systems
              for years.
            </span>
          </>
        ),
        image: {
          ...
          alt: "Professional Elba Maintenance in Madinaty for Cookers & Ovens",
          label: "Professional Elba Maintenance",
        },
      },
    ],
    [],
  ...
  const faqs: FaqItemType[] = useMemo(
    () => [
      {
        q: "Who is the best provider for Elba Maintenance in Madinaty cookers?",
        a: (
          <p>
            <strong>American Group</strong>
            ...
            <span> with on-site diagnostics. Call </span>
            <strong>01211114528</strong>
            <span> to book your </span>
            <strong>Elba Maintenance in Madinaty</strong>
            <span> immediately and get original Italian parts.</span>
          </p>
        ),
      },
      {
        q: "How can I book Elba Maintenance in Madinaty for an oven?",
        a: (
          <p>
      ...
      {
        q: "Is there Elba Maintenance in Madinaty for kitchen hoods?",
        a: (
          <p>
      ...
      {
        q: "Where can I find Elba Maintenance in Madinaty for dishwashers?",
        a: (
          <p>
  ...
  const schemaGraph = useMemo(() => {
    return {
      ...
      "@graph": [
        {
          "@type": "LocalBusiness",
          name: "American Group - Elba Maintenance in Madinaty",
          url: "https://alba-eg.com/en/elba-maintenance-in-madinaty",
          image:
          ...
          areaServed: [
            { "@type": "City", name: "Madinaty Villas" },
            { "@type": "City", name: "Madinaty Apartments" },
            { "@type": "City", name: "Madinaty Districts" },
          ],
        },
        {
          "@type": "FAQPage",
          mainEntity: [
            {
              "@type": "Question",
              name: "Who is the best provider for Elba Maintenance in Madinaty?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "American Group is the leading expert for Elba Maintenance in Madinaty. Call 01211114528 for on-site repair with original Italian parts and a 12-month warranty.",
              },
            },
            {
              "@type": "Question",
              name: "How can I book Elba Maintenance in Madinaty for an oven?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "Call 01211114528 to book Elba Maintenance in Madinaty for ovens. Our mobile team performs all repairs at your home in Madinaty using certified Italian spare parts.",
              },
            },
            {
              "@type": "Question",
              name: "Is there Elba Maintenance in Madinaty for kitchen hoods?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "Yes, we provide Elba Maintenance in Madinaty for hoods. Call 01211114528 or WhatsApp us to fix motor and suction issues today with original parts.",
              },
            },
          ],
        },
          ...
          <div className="container mx-auto px-4 h-full flex items-center justify-center">
            <div className="text-center text-white z-10 max-w-3xl">
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 font-cairo leading-tight lg:leading-[5rem]">
                Elba Maintenance in Madinaty | Elite Italian Appliance Repair
              </h1>
